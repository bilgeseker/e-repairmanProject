            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="http://localhost/repairman/anasayfa/">Home</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <?php
                                foreach ($isler as $is) {
                                    echo '<li><a class="dropdown-item" href="http://localhost/repairman/tamirci_liste/' . $is["id"] . '">' . $is["is_adi"] . '</a></li>';
                                }
                                ?>
                            </ul>
                        </li>
                    ...
                    if (!isset($_SESSION["kullanici_id"])) {
                        ...
                        <a class="btn btn-outline-primary dropdown-toggle"
                            style="background-color: #a2a8d3;  border:none; color:black;" href="#" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fa-solid fa-id-badge me-1"></i>Register
                        </a>

                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="http://localhost/repairman/repairman/kayit">Repairman</a></li>
                            <li><a class="dropdown-item" href="http://localhost/repairman/kayit">Customer</a></li>
                        </ul>
                    </div>
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="http://localhost/repairman/repairman/giris">Repairman</a></li>
                            <li><a class="dropdown-item" href="http://localhost/repairman/giris">Customer</a></li>
                        </ul>
                    </div>';
                    }
                    ?>
